    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body pt-2">
          <form action="{{route('donatur.store')}}" class="row g-3" method="post">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <input type="text" name="donatur" id="donatur" class="form-control mb-2 @error('donatur') is-invalid @enderror" placeholder="Nama Pribadi atau Perusahaan" value="{{old('donatur')}}">
              @error('donatur')
              <div class="invalid-feedback">
                {{$message}}
              </div>
